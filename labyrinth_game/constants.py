...
ROOMS = {
    ...
    'library': {
        ...
        'armory': {
          'description': 'Старая оружейnorthная комната. На стене висит меч, рядом — небольшая бронзовая шкатулка.',
          'exits': {'south': 'library'},
    ...
    'treasure_room': {
          ...
          'puzzle': ('Дверь защищена кодом.go Введите код (подсказка: это число пятикратного шага, 2*5= ? )', '10')
    }
